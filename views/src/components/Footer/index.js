      ...
      <StyledNavbar className="footer-nav">
        <div className="clearfix">
          <StyledNavItems className="bottom-nav">
            <li>
              <StyledLink to="/">
                Copyright <FontAwesomeIcon icon={faCopyright} size="2x" />{" "}
            ...
            <li>
              <StyledAnchor
                href="https://www.linkedin.com/in/taylor-remigi-7178281a5/"
                target="_blank"
              >
            ...
            <li>
              <StyledAnchor
                href="https://www.linkedin.com/in/mario-dubon-6a1081158/"
                target="_blank"
              >
